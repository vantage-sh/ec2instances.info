...
<%inherit file="base.mako" />
    ...
    <div class="row mt-3 me-2" id="menu">
      <div class="col-sm-12 ms-2">
        ...
        <div class="btn-group-vertical d-none d-inline-block" id="pricing-unit-dropdown">
        ...
        <div class="btn-group-vertical d-none d-inline-block" id='reserved-term-dropdown'>
