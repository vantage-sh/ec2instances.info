...
<%inherit file="base.mako" />
    ...
    <%block name="meta">
        <title>Amazon SageMaker Instance Comparison</title>
        <meta name="description" content="A free and easy-to-use tool for comparing SageMaker Instance features and prices."></head>
    </%block>

    <%block name="header">
      <h1 class="banner-ad d-none d-xl-block">EC2Instances.info Easy Amazon <b>SageMaker</b> Instance Comparison</h1>
    </%block>
