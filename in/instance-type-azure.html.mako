                    ...
                    <div class="mb-4 d-flex flex-container justify-content-center">
                      <div class="row">
                        ...
                        <div class="d-flex justify-content-center mt-4">
                          <span class="fw-semibold" style="color:#6c757d">Concerned about cloud costs? <a href="https://console.vantage.sh/signup">Connect your Azure account</a> in under 5 minutes to see savings.</span>
                        </div>
                      </div>
                    </div>
                  % endif
