...
def add_pretty_names(instances):
    family_names = {
        ...
        "r6gd": "R6gd Memory optimized (w/ data tiering)",
        "r6g": "R6g Memory optimized (w/ data tiering)",
        "r5": "R5 Memory optimized (w/ data tiering)",
        "r4": "R4 Memory optimized (w/ data tiering)",
        "r3": "R3 Memory optimized (w/ data tiering)",
