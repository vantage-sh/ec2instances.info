...
const initialColumnsArr = [
    ...
    ["cost-ondemand-410", false],
    ["cost-reserved-410", false],
...
export const columnsGen = (
    ...
    {
        header: "Oracle Enterprise BYOL On Demand Cost",
        id: "cost-ondemand-410",
        accessorKey: "pricing",
        ...getPricingSorter(
            selectedRegion,
            pricingUnit,
            costDuration,
            (pricing) => pricing?.["410"]?.ondemand,
            true,
            currency,
        ),
    },
    {
        header: "Oracle Enterprise BYOL Reserved Cost",
        id: "cost-reserved-410",
        accessorKey: "pricing",
        ...getPricingSorter(
            selectedRegion,
            pricingUnit,
            costDuration,
            (pricing) => pricing?.["410"]?.reserved?.[reservedTerm],
            true,
            currency,
        ),
    },
