...
const reservedTermOptions: [string, string][] = [
    ["Savings.noUpfront", "No Upfront (Compute Savings Plan)"],
    ["Savings.partialUpfront", "Partial Upfront (Compute Savings Plan)"],
    ["Savings.allUpfront", "All Upfront (Compute Savings Plan)"],
