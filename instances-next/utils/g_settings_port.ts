...
function validate<K extends GSettingsKey>(params: URLSearchParams, obj: GSettingsDefault, key: K): void;
function validate<K extends GSettingsKey>(params: URLSearchParams, obj: GSettingsDefault, key: K, f?: (item: string) => GSettingsDefault[K]): void;
function validate<K extends GSettingsKey>(params: URLSearchParams, obj: GSettingsDefault, key: K, f?: (item: string) => GSettingsDefault[K]): void {
