...
export async function generateAwsIndexes() {
    ...
    for (const [slug, instances] of buckets.entries()) {
        const markdown = generateIndexMarkdown(awsIndexes.find((i) => i.slug === slug)!.name, instances);
